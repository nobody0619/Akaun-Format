...
const LEVEL_9_GRAPH_ZONES: DropZoneConfig[] = [
  { id: 'g_y_axis', expectedLabels: ["Kos/Hasil (RM '000)"], widthClass: '', customStyle: { top: '1%', left: '1%', width: 'clamp(76px, 20%, 160px)' } },
  { id: 'g_x_axis', expectedLabels: ["Pengeluaran ('000 unit)"], widthClass: '', customStyle: { bottom: '1%', right: '1%', width: 'clamp(90px, 26%, 208px)' } },
  { id: 'g_jh', expectedLabels: ["Jumlah Hasil"], widthClass: '', customStyle: { top: '15%', right: '2%', width: 'clamp(64px, 16%, 128px)' } },
  { id: 'g_jk', expectedLabels: ["Jumlah Kos"], widthClass: '', customStyle: { top: '35%', right: '2%', width: 'clamp(64px, 16%, 128px)' } },
  { id: 'g_kt', expectedLabels: ["Kos Tetap"], widthClass: '', customStyle: { top: '68%', right: '2%', width: 'clamp(64px, 16%, 128px)' } },
  { id: 'g_tpm', expectedLabels: ["Titik Pulang Modal"], widthClass: '', customStyle: { top: '47%', left: '13%', width: 'clamp(76px, 18%, 144px)' } },
  { id: 'g_untung', expectedLabels: ["UNTUNG"], widthClass: '', customStyle: { top: '34%', left: '49%', width: 'clamp(56px, 14%, 112px)' } },
  { id: 'g_rugi', expectedLabels: ["RUGI"], widthClass: '', customStyle: { top: '71%', left: '14%', width: 'clamp(52px, 12%, 96px)' } }
]
...
const LEVEL_20_STRUCTURE: RowConfig[] = [
  headerRow('l20_bahan_header', 'Kos Bahan Langsung', { isUnderlined: true, underlineLabel: true }),
  ...
  headerRow('l20_buruh_header', 'Kos Buruh Langsung', { isUnderlined: true, underlineLabel: true }),
  ...
  headerRow('l20_belanja_header', 'Belanja langsung', { isUnderlined: true, underlineLabel: true }),
  ...
  headerRow('l20_overhed_header', 'Kos Overhed', { isUnderlined: true, underlineLabel: true }),
...
const LEVEL_21_STRUCTURE: RowConfig[] = [
  headerRow('l21_bahan_header', 'Kos Bahan Langsung', { isUnderlined: true, underlineLabel: true }),
  ...
  headerRow('l21_buruh_header', 'Kos Buruh Langsung', { isUnderlined: true, underlineLabel: true }),
  single('l21_upah_langsung', 'Upah langsung', 'x', 2),

  headerRow('l21_belanja_header', 'Belanja langsung', { isUnderlined: true, underlineLabel: true }),
  single('l21_hak_cipta', 'Hak cipta', 'x', 1, 0, { hasBottomBorder: true }),
  single('l21_kos_prima', 'Kos Prima', 'xx', 2, 0, { isHeader: true }),

  headerRow('l21_overhed_header', 'Kos Overhed', { isUnderlined: true, underlineLabel: true }),
...
const LEVEL_22_STRUCTURE: RowConfig[] = [
  ...
  single('l22_inv_awal_barang', 'Inventori Awal barang siap', 'x', 1),
  single('l22_belian_barang', 'Belian barang siap', 'x', 0),
  single('l22_kos_pengeluaran', 'Kos Pengeluaran', 'x', 0, 0, { hasBottomBorder: true }),
  single('l22_kos_barang_siap', 'Kos barang siap', 'xx', 1),
  operatorRow('l22_inv_akhir_barang', 'Tolak', 'Inventori Akhir barang siap', '(x)', 1, 0, { hasBottomBorder: true }),
  single('l22_kos_jualan', 'Kos Jualan', '(xx)', 2, 0, { hasBottomBorder: true }),
  single('l22_untung_kasar', 'Untung Kasar', 'xxx', 2, 0, { isTotal: true, isHeader: true })
];
